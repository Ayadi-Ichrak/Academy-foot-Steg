...
$req = "SELECT * FROM Paiement_Joueur where id='$id' ";
...
if ($_POST) {
    ...
    $req2 = "UPDATE Paiement_Joueur SET code='$code',
nom = '$nom', 
prenom = '$prenom', 
montant = '$montant',
...
WHERE id = '$id'";
    ...
    if ($result) {
        ...
        header("location: historique_paiementJoueur.php");
        exit;
    } else {
...
<head>
    ...
    <title>Modification Paiement Joueur </title>
            ...
            <div class="affichageTable">
                <div class="cardHeader">
                    <form action="" class="formADD" method="POST" enctype="multipart/form-data">
                        <h2>Modifier Paiement Joueur</h2>
