...
$joueur_code = isset($_GET['joueur_code']) ? mysqli_real_escape_string($con, $_GET['joueur_code']) : '';

// Fetch the row based on the ID
$query = "SELECT Joueur.code ,Joueur.nom,Joueur.prenom,Joueur.date_naissance, Joueur.photo, Joueur.groupe_id AS groupe, Joueur.parent_cin FROM Joueur WHERE Joueur.code = '$joueur_code'";
