...
<div class="main">
        <div class="topbar">
            ...
            <div class="search">
                <form action="rechercheTerrain.php" method="GET">
                ...
                <table>
                    ...
                    <TBody>
                        ...
                        <tr>
                            ...
                            <?php if ($userType == 'Admin') { ?>
                            <td align="center"><a onclick="return confirm('Êtes-vous sûr de vouloir modifier ce Terrain ?')" href="editTerrainTerrain.php?id=<?php echo ($row["id"]);?>"><ion-icon name="create-outline"></ion-icon></a></td>
